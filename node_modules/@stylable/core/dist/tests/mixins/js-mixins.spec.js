...
describe('Javascript Mixins', function () {
    ...
    it('should not root scope js mixins', function () {
        ...
        test_utils_1.matchRuleAndDeclaration(result, 0, '.entry--gaga', 'color:red;background:green');
        test_utils_1.matchRuleAndDeclaration(result, 1, '.entry--gaga .entry--child', 'color:yellow');
    });
