...
describe('CSS Mixins', function () {
    ...
    it('separate mixin roots', function () {
        var result = test_utils_1.generateStylableRoot({
            entry: "/entry.st.css",
            files: {
                '/entry.st.css': {
        ...
        test_utils_1.matchRuleAndDeclaration(result, 0, '.entry--b', 'color: green;background: red');
        test_utils_1.matchRuleAndDeclaration(result, 1, '.entry--b:hover', 'color: yellow');
        test_utils_1.matchRuleAndDeclaration(result, 2, '.entry--b', 'color: black');
    });
    it('re-exported mixin maintains original definitions', function () {
        var result = test_utils_1.generateStylableRoot({
            entry: "/entry.st.css",
            files: {
                '/entry.st.css': {
        ...
        test_utils_1.matchRuleAndDeclaration(result, 0, '.entry--b', 'color: red');
        test_utils_1.matchRuleAndDeclaration(result, 1, '.entry--b', 'color: green');
    });
    it('re-exported mixin maintains original definitions (with multiple selectors)', function () {
        var result = test_utils_1.generateStylableRoot({
            entry: "/entry.st.css",
            files: {
                '/entry.st.css': {
        ...
        test_utils_1.matchRuleAndDeclaration(result, 0, '.entry--b', 'color: red');
        test_utils_1.matchRuleAndDeclaration(result, 1, '.entry--b:hover', 'color: gold');
        test_utils_1.matchRuleAndDeclaration(result, 2, '.entry--b', 'color: green');
        test_utils_1.matchRuleAndDeclaration(result, 3, '.entry--b:hover', 'color: yellow');
        test_utils_1.matchRuleAndDeclaration(result, 4, '.entry--b', 'color: purple');
    });
    it("apply mixin from named \"as\" import to a target class sharing the mixin source name", function () {
        var result = test_utils_1.generateStylableRoot({
            entry: "/entry.st.css",
            files: {
                '/entry.st.css': {
        ...
        test_utils_1.matchRuleAndDeclaration(result, 0, '.entry--a', 'color: red');
    });
