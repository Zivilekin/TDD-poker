...
var pseudo_states_1 = require("../src/pseudo-states");
...
chai_1.use(chai_subset_1.default); // move all of these to a central place
...
describe('pseudo-states', function () {
    describe('process', function () {
        ...
        describe('boolean', function () {
            it('should collect state definitions as null (for boolean)', function () {
                var _a;
                var _b = generate_test_util_1.processSource("\n                    .root {\n                        -st-states: state1, state2;\n                    }\n                ", { from: 'path/to/style.css' }), classes = _b.classes, diagnostics = _b.diagnostics;
                chai_1.expect(diagnostics.reports.length, 'no reports').to.eql(0);
                chai_1.expect(classes).to.flatMatch({
                    root: (_a = {},
                        _a[src_1.valueMapping.states] = {
                            state1: null,
                            state2: null
                        },
                        _a)
        ...
        describe('advanced type', function () {
            it('should warn when a state receieves more than a single state type', function () {
                diagnostics_1.expectWarnings("\n                    .root{\n                        |-st-states: $state1(string, number(x))$|;\n                    }\n                ", [{
                        message: pseudo_states_1.stateErrors.TOO_MANY_STATE_TYPES('state1', ['string', 'number(x)']),
                        file: 'main.css'
                    }]);
            });
            it('should warn when a state function receives no arguments', function () {
                diagnostics_1.expectWarnings("\n                    .root{\n                        |-st-states: $state1()$|;\n                    }\n                ", [{
                        message: pseudo_states_1.stateErrors.NO_STATE_TYPE_GIVEN('state1'),
                        file: 'main.css'
                    }]);
            });
            it('should warn when a validator function receives more than a single argument', function () {
                diagnostics_1.expectWarnings("\n                    .my-class {\n                        |-st-states: $state1( string( contains(one, two) ) )$|;\n                    }\n                ", [{
                        message: pseudo_states_1.stateErrors.TOO_MANY_ARGS_IN_VALIDATOR('state1', 'contains', ['one', 'two']),
                        file: 'main.css'
                    }]);
            });
            it('should warn when encountering an unknown type', function () {
                diagnostics_1.expectWarnings("\n                    .my-class {\n                        |-st-states: state1( $unknown$ )|;\n                    }\n                ", [{
                        message: pseudo_states_1.stateErrors.UNKNOWN_STATE_TYPE('state1', 'unknown'),
                        file: 'main.css'
                    }]);
            });
    ...
    describe('transform', function () {
        ...
        describe('advanced type / validation', function () {
            ...
            it('should strip quotation marks when transform any state parameter', function () {
                var res = generate_test_util_1.generateStylableResult({
                    entry: "/entry.st.css",
                    files: {
                        '/entry.st.css': {
        ...
        describe('inheritance', function () {
            ...
            it('state lookup when exported as element', function () {
                var result = generate_test_util_1.generateStylableResult({
                    entry: "/entry.st.css",
                    files: {
                        '/entry.st.css': {
                            namespace: 'entry',
                ...
                chai_1.expect(result.meta.diagnostics.reports, 'no diagnostics reported for imported states').to.eql([]);
                chai_1.expect(result).to.have.styleRules({
        ...
        describe('extends local root with states', function () {
            it('resolve states from extended local root', function () {
                var result = generate_test_util_1.generateStylableResult({
                    entry: "/entry.st.css",
                    files: {
                        '/entry.st.css': {
        ...
        describe('state after pseudo-element', function () {
            it('transform states after pseudo-element that extends states', function () {
                var result = generate_test_util_1.generateStylableResult({
                    entry: "/entry.st.css",
                    files: {
                        '/entry.st.css': {
    ...
    describe('diagnostics', function () {
        ...
        it('should trigger a warning when trying to target an unknown state and keep the state', function () {
            var config = {
                entry: "/entry.st.css",
                files: {
                    '/entry.st.css': {
            ...
            var res = diagnostics_1.expectWarningsFromTransform(config, [
                { message: pseudo_states_1.stateErrors.UNKNOWN_STATE_USAGE('unknownState'), file: '/entry.st.css' }
            ]);
        ...
        it('should warn when defining a state inside an element selector', function () {
            diagnostics_1.expectWarnings("\n                MyElement {\n                    |-st-states|:shmover;\n                }\n            ", [
                ...
                { message: src_1.processorWarnings.UNSCOPED_ELEMENT('MyElement'), file: 'main.css', skip: true },
        ...
        it('should warn when defining a state starting with "--"', function () {
            diagnostics_1.expectWarnings("\n                .root {\n                    |-st-states: $--someState$|;\n                }\n            ", [{
                    message: pseudo_states_1.stateErrors.STATE_VARIABLE_NAME_CLASH('--someState'),
                    file: 'main.css',
                    severity: 'error'
                }]);
        });
