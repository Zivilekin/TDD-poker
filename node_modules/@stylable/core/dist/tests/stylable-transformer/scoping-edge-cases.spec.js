...
describe('scoping-edge-cases', function () {
    it('root scoping always uses origin meta', function () {
        ...
        chai_1.expect(result.nodes[1].selector).to.equal('.style--x .comp--part .inner--inner');
    });
    it('meta from pseudo-elements leak into the next selector', function () {
        ...
        chai_1.expect(result.nodes[1].selector).to.equal('.style--x .comp--part .inner--inner, .style--x[data-style-test]');
    });
});
