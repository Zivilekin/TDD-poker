...
describe('stylable-resolver', function () {
    ...
    it('should resolve 4th party according to context', function () {
        ...
        var meta = stylable.transform(stylable.process('/node_modules/a/index.st.css')).meta;
        var rule = meta.outputAst.nodes[0];
        chai_1.expect(rule.selector).to.equal('.A--root');
    });
});
