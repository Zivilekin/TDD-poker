...
declare type ProjectType = 'app' | 'library';
declare type PetriOptions = {
    onlyForLoggedInUsers?: boolean;
    scopes?: Array<string>;
};
declare type CdnConfig = {
    url: string;
    port: number;
    dir: string;
    ssl: boolean;
...
export declare type StartUrl = string | Array<string> | null;
declare type HooksConfig = {
    prelint?: string;
};
declare type SpecsConfig = {
    browser?: string;
    node?: string;
};
...
declare type WebpackEntry = string | Array<string> | Entry | EntryFunc;
declare type WebpackExternals = ExternalsElement | Array<ExternalsElement>;
declare type WebpackResolveAlias = {
    [key: string]: string;
};
export declare type InitialConfig = {
    extends?: string;
