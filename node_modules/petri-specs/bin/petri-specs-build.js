...
program
  ...
  .option(
    '--only-for-logged-in-users [isOnlyForLoggedInUsers]',
    'will the translations specs be created only for logged in users',
    toBoolean,
    true,
  )
  .option(
    '--scopes <scopes>',
    'comma separated scopes for the translation specs',
    list,
  )
  .parse(process.argv);
