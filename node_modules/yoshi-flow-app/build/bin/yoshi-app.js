...
const commands = {
    ...
    release: () => Promise.resolve().then(() => __importStar(require('yoshi-flow-legacy/bin/yoshi-legacy'))),
};
...
Promise.resolve().then(async () => {
    ...
    const config = loadConfig_1.default();
...
//# sourceMappingURL=yoshi-app.js.map