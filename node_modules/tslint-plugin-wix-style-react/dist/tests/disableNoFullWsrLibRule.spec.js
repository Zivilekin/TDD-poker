...
var rulesDirectory = path.resolve(__dirname, '../src');
describe('Disable no-full-wsr-lib if WSR version is greater than 5.8.1', function () {
    var base = path.resolve(__dirname, 'fixtures', 'disableNoFullWsrLibRule');
    var cwd;
    beforeEach(function () {
        cwd = process.cwd();
        process.chdir(base);
    ...
    it("should not fail", function () {
        ...
        var result = lintRunner_1.helper({ src: src, rule: rule, rulesDirectory: rulesDirectory });
    ...
    it('should not fail for destructured import statement', function () {
    ...
    it('should fix destructured require statement', function () {
        ...
        var result = lintRunner_1.helper({ src: src, rule: rule, rulesDirectory: rulesDirectory });
        expect(result.errorCount).toBe(1);
        expect(lintRunner_1.getFixedResult({ src: src, rule: rule, rulesDirectory: rulesDirectory })).toEqual(output);
    });
    ...
    it.only('should not fix requiring all the lib', function () {
        var src = "const WSR = require('wix-style-react');";
    ...
    describe('regression tests', function () {
        it("should not throw an error", function () {
            ...
            */
            ...
            lintRunner_1.helper({ src: src, rule: rule, rulesDirectory: rulesDirectory });
            expect(spy).toHaveBeenCalledTimes(0);
            spy.mockRestore();
        });
    });
});
//# sourceMappingURL=disableNoFullWsrLibRule.spec.js.map