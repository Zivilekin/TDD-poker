const pokerFuncs = [
    royalFlush = (hand) => doesHandHaveRoyalInARow(hand) && doesHandHaveSameSuits(hand) ? pokerHands.royalFlush : null,
    straightFlush = (hand) => doesHandHaveCardsInARow(hand) && doesHandHaveSameSuits(hand) ? pokerHands.straightFlush : null,
    fourOfAKind = (hand) => getValueOfArray(repeatingCards(hand)) === getValueOfArray([4]) ? pokerHands.fourOfAKind : null,
    fullHouse = (hand) => getValueOfArray(repeatingCards(hand)) === getValueOfArray([2,3]) || getValueOfArray(repeatingCards(hand)) === getValueOfArray([3,2]) ? pokerHands.fullHouse : null,
    flush = (hand) => doesHandHaveSameSuits(hand) ? pokerHands.flush : null,
    straight = (hand) => doesHandHaveCardsInARow(hand) ? pokerHands.straigth : null,
    threeOfAKind = (hand) => getValueOfArray(repeatingCards(hand)) === getValueOfArray([3]) ? pokerHands.threeOfAKind : null,
    twoPairs = (hand) => getValueOfArray(repeatingCards(hand)) === getValueOfArray([2,2]) ? pokerHands.twoPairs : null,
    pair = (hand) => getValueOfArray(repeatingCards(hand)) === getValueOfArray([2]) ? pokerHands.pair : null,
...
function doesHandHaveRoyalInARow(hand) {
    ...
    return cardsInARow && queue.includes(cardsInARow.join('')) && cardsInARow[0] === 'T';
}
...
module.exports = {compareHands, getRankOfHand, doesHandHaveSameSuits, doesHandHaveCardsInARow, repeatingCards, pokerHands};